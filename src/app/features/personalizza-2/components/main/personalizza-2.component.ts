...
@Component({
  selector: 'app-personalizza-2',
  templateUrl: './personalizza-2.component.html',
  styleUrls: ['./personalizza-2.component.scss']
})
export class Personalizza2Component implements OnInit {
