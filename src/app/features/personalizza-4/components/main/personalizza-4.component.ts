...
@Component({
  selector: 'app-personalizza-4',
  templateUrl: './personalizza-4.component.html',
  styleUrls: ['./personalizza-4.component.scss']
})
export class Personalizza4Component implements OnInit {
